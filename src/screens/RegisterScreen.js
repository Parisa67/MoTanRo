...
class RegisterScreen extends Component {
      ...
      <KeyboardAvoidingView style={styles.container} enabled>
        <View style={styles.container}>
          <ImageBackground
            ...
            >
              <View style={{ flex: 8, justifyContent: 'center', alignItems: 'center', marginBottom: 10, }}>

                <Text style={{ fontSize: 25, color: 'black', marginTop: 40, marginBottom: 30 }}>ثبت نام حساب کاربری</Text>
                ...
                <View style={styles.viewin}>
                  ...
                  <TouchableOpacity
                    ...
                    <Icon
                      name={this.state.press1 == false ? "eye-with-line" : "eye"}
                      type="Entypo"
                ...
                <View style={styles.viewin}>
                  ...
                  <TouchableOpacity
                    ...
                    style={{ position: "absolute", left: 8, top: 20 }}>
                    <Icon
                      name={this.state.press2 == false ? "eye-with-line" : "eye"}
                      type="Entypo"
                      style={{ fontSize: 24, color: "rgba(1,1,1,0.4)", }} />
                  </TouchableOpacity>
                </View>
  ...
  _Register = async () => {
    ...
    else if (this.state.password1 != this.state.password2) { alert("تایید کلمه عبور نامعتبر است!") }
    else {
      var myHeaders = new Headers();
      myHeaders.append("Content-Type", "application/json");

      var raw = JSON.stringify({
        "fullName": this.state.user, "email": this.state.mail,
        "password": this.state.password1, "confirmPassword": this.state.password2,
        "phone": this.state.tel, "company": this.state.company
      });
