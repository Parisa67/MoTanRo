...
class ListKalagirlScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            ...
            <View style={
                ...
                <ScrollView>
                    ...
                    <View style={{ marginTop: 16, marginLeft: 5, marginRight: 5 }}>
                        ...
                        <FlatList numColumns={2} showsHorizontalScrollIndicator={false} data={this.state.Girl}
                            renderItem={({ item }) => (
...
export default ListKalagirlScreen;
